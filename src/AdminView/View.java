...
public abstract class View {
	public abstract int view(final Manager manager, final User user) throws Exception;
	
	protected int menuProcess(final Manager manager, final User user, int menuType) throws Exception{
